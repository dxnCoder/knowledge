...
//预先读取模板文件
var templates = {
    baseHtml: $fs.readFileSync(__path + '/www/templates/base.html', 'utf-8').replace(/\[\{codeHere_*\w*\}\]/g, ''),
    baseJs: $fs.readFileSync(__path + '/www/templates/base.js', 'utf-8').replace(/\[\{codeHere_*\w*\}\]/g, ''),
};
